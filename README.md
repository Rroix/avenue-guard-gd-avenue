...
On Render Web Services, Avenue Guard binds the health-check port before Discord login starts. That keeps Render from killing the deploy while the bot is waiting out a temporary Discord login rate limit.
